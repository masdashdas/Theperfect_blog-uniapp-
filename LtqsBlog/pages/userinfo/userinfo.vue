<template>
	<view class="userinfo">
		...
		<view class="userinfo-ctx" v-else>
			...
			<view class="userinfo-C">
				<view class="userinfo-H">
					<view class="avatar">
						<avatar-item height="220" width="220" :avatar="avatar(userinfo)" :frame="frame(userinfo)"></avatar-item>
					</view>
					<view class="info">
						...
						<view class="timer info-I">{{vk.pubfn.timeFormat(userinfo.register_date,"yyyy-MM-dd")}}注册</view>
					</view>
			...
			<view class="art">
				...
				<view class="art-C">
					<view v-if="artData.length!=0">
						...
						<loading-item :status="artStatus"></loading-item>
					</view>
