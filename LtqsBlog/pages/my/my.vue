	...
	<view class="my">
						...
						<view class="info-center" @click="ToUsercenter">
							<view class="info-center-left">
								<view class="avatar">
									...
									<view class="name">
										<view class="nameT">昵称:<text>{{username(userinfo)}}</text></view>
										<view class="gender">
											性别:<image :src="`../../static/img/${genderFn(userinfo.gender)}.png`"></image>
										</view>
										<view class="signT">签名:<text>{{gxqm(userinfo)}}</text></view>
										<!-- <view class="timer">
		...
		<view class="art">
			<view class="art-C">
				...
				<view v-else>
					<view class="art-C-I" v-if="artData.length!=0">
				...
				<view class="popCtx">
					...
					<scroll-view class="scroll" scroll-y>
						<u-cell-group class="cell" title="我的" :title-style="{height:'50px'}" border>
							...
							<u-cell-item @click="TomyFans('following')" icon="man-add" :border-bottom="false" title="我的关注"></u-cell-item>
						</u-cell-group>
						...
						<u-cell-group class="cell" title="更多" :title-style="{height:'50px'}" border>
							...
							<u-cell-item @click="ToMyAbout" icon="man-add" :border-bottom="false" title="关于我们"></u-cell-item>
							<u-cell-item v-if="vk.getVuex('$user.userInfo.role[0]') == 'admin'" @click="ToAdmin" icon="setting" :border-bottom="false" title="后台管理"></u-cell-item>
						</u-cell-group>
...
function getUserArt(){
	apiGetUserArt({pageIndex:pageIndex.value,Audit:0}).then(res=>{
...
function TouserInfo(){
	vk.navigateTo('/pages/userinfo/userinfo?id='+vk.getVuex('$user.userInfo')._id)
}
